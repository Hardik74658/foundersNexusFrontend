...
const PostDetails = () => {
  ...
  const fetchPost = useCallback(async () => {
    try {
      const response = await axios.get(`htttp://http://13.232.209.194/posts/${postId}`);
  ...
  const handleLike = async () => {
    ...
    try {
      await axios.post(`htttp://http://13.232.209.194/posts/${postId}/like/${userId}`);
  ...
  const handlePostComment = async () => {
    ...
    try {
      ...
      await axios.post(
        `htttp://http://13.232.209.194/posts/${postId}/comments`,
        commentData
      );
  ...
  const confirmDelete = async () => {
    ...
    try {
      await axios.delete(`htttp://http://13.232.209.194/posts/${postId}`);
