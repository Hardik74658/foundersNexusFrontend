...
export default function Reg() {
  ...
  const handleFinalSubmit = async (data) => {
    ...
    try {
      ...
      let userId=null;
      try{
        const userResponse = await axios.post('htttp://http://13.232.209.194/users', userDetails);
      ...
      if (founderDetails) {
        try{
          ...
          let founderResponse = await axios.post('htttp://http://13.232.209.194/users/entrepreneurs/', founderDetails);
      ...
      if (investorDetails) {
        try{
          ...
          let investorResponse = await axios.post('htttp://http://13.232.209.194/users/investors/', investorDetails);
