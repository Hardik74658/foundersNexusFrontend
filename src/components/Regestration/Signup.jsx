    ...
    try {
      ...
      try {
        ...
        userResponse = await axios.post(
          "/api/users", // Ensure this endpoint is correct
          formData,
          {
            headers: {
      ...
      if (data.role === 'founder') {
        ...
        try {
          const founderResponse = await axios.post('/api/users/entrepreneurs/', founderDetails);
      ...
      if (data.role === 'investor') {
        ...
        try {
          const investorResponse = await axios.post('/api/users/investors/', investorDetails);
